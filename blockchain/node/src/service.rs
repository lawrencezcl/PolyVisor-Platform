use polyvisor_runtime::{self, opaque::Block, RuntimeApi};
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
    ...
    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        polyvisor_runtime::api::dispatch(method, data)
    }

    fn native_version() -> sc_executor::NativeVersion {
        polyvisor_runtime::native_version()
    }
}
...
pub fn new_full(config: Configuration) -> Result<TaskManager, ServiceError> {
    ...
    if role.is_authority() {
        ...
        let aura = sc_consensus_aura::start_aura::<sp_consensus_aura::sr25519::AuthorityPair, _, _, _, _, _, _, _, _>(
    ...
    if enable_grandpa {
        ...
        // start the full GRANDPA voter
        // NOTE: coordinates the GRANDPA voter gadget
        let grandpa_voter = sc_finality_grandpa::run_grandpa_voter(sc_finality_grandpa::GrandpaParams {
